...
export function PlayerBar() {
  ...
  // Si no hay canción reproduciéndose, no mostrar la barra
  if (!current) {
    return null; 
  }

  return (
    // Toda la barra es clickable para expandir el reproductor
    <div 
    ...
    >
      ...
      {/* Título y Artista (con efecto marquesina) */}
      ...
      {/* Controles de Play/Pause, Anterior y Siguiente (fijos a la derecha) */}
      ...
      {/* Barra de progreso simple (debajo de la información de la canción) */}
      ...
      {/* Estilos para la animación de marquesina */}
      <style jsx>{`
        @keyframes marquee {
